...
sample_text = """
Barca are tough for protagonist teams but they are tough in the same way De Zerbi's Brighton are tough—they force you to play them at their own rhythm.

Which is, ironically, heritage Barcelona. A club that plays a game no one else plays in the world.

Barca essentially force you to play a game of small halves, with the pitch cut halfway. High-intensity, direct attacks. Most teams are just not ready to play ping-pong instead of football. 
The best way to beat Barca is to be Barca. Range passers, runners, carriers. A No. 9 with pausa.

PSG have the passers and carriers but hardly the runners and no 9

Arsenal have the 9 but he is injured, they have carriers and runners and the passers if Partey/Jorginho/MLS are on their A game

Inter are also similar. Their wingbacks make good runs. And they have Calha/Bastoni to pass

Probably Inter/Arsenal
 """
